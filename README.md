...
# includes per-case reports and summary.json (mode/schemaVersion/selectedCases + expected/runtime labels + passed/failed case lists + preflight/overall timing + slowest cases)
```

#!/usr/bin/env python3
"""
v28 full eval: Hybrid BM25 + Semantic + RRF on all 500 questions.
Streams questions to avoid OOM on 277MB dataset.
"""
import json
import os
import sys
...
class ClawVaultV28(MemorySystem):
    ...
    def _rrf(self, bm25_results, semantic_results, k=60):
    ...
    def query(self, question, question_date=None, **kwargs):
        ...
        fused = self._rrf(bm25_results, semantic_results)
...
def stream_questions(filepath):
    """Stream questions from large JSON file one at a time."""
...
def main():
    ...
    output_file = os.path.join(RESULTS_DIR, "v28-full-answers.jsonl")
    ...
    print("Streaming questions from dataset...")

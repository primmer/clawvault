#!/usr/bin/env python3
"""
v37: v34 (type-adaptive BM25+semantic+RRF) + SELECTIVE fact injection.

Key fix over v36 (47.6%): facts ONLY injected for preference + knowledge-update questions.
v36 hurt single-session-user (84.3->40.0%) by injecting noisy facts into simple retrieval.
v37 = v34 baseline for SSU/SSA/multi/temporal + facts for preference/knowledge only.
"""
import json
import os
import sys
...
class ClawVaultV37(MemorySystem):
    name = "ClawVault-v37"
...
def main():
    ...
    output_file = os.path.join(RESULTS_DIR, "v37-full-answers.jsonl")

#!/usr/bin/env python3
"""
v40: Conditional fact injection — only for question types that benefit.

v39 showed facts help multi-session (+8.3pp) and knowledge (+6.4pp) but hurt
SSU (-10pp) and SSA (-7.2pp). Fix: only inject facts for beneficial types.

Baseline: v39 = 60.0%, v34 = 58.8%
Target: 65%+
"""
import json
import os
...
def main():
    ...
    output_file = os.path.join(RESULTS_DIR, "v40-full-answers.jsonl")

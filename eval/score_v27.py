#!/usr/bin/env python3
"""Score v27 multi-session results using Gemini as judge."""
import json
import os
import sys
import time
...
def main():
    results_file = os.path.join(os.path.dirname(__file__), "results", "v27-multi-answers.jsonl")
    ...
    print(f"Scoring {len(results)} v27 multi-session answers...")
    ...
    print(f"\n{'='*60}")
    print(f"v27 Multi-Session Results")
    print(f"{'='*60}")

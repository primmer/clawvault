#!/usr/bin/env python3
"""Score v31 multi-session results using Gemini as judge."""
import json
import os
import sys
import time
...
def main():
    results_file = os.path.join(os.path.dirname(__file__), "results", "v31-multi-answers.jsonl")
    ...
    print(f"Scoring {len(results)} v31 multi-session answers...")
    ...
    print(f"\n{'='*60}")
    print(f"v31 Multi-Session Results")
    print(f"{'='*60}")

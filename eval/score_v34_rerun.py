#!/usr/bin/env python3
"""Score v34 full 500-question results using Gemini as judge."""
import json
import os
import sys
import time
...
def main():
    results_file = os.path.join(os.path.dirname(__file__), "results", "v34-full-answers.jsonl")
    ...
    print(f"Scoring {len(results)} v34 full answers...")
    ...
    print(f"\n{'='*60}")
    print(f"LongMemEval Results — ClawVault v34 (hybrid BM25+semantic+RRF)")
    print(f"{'='*60}")

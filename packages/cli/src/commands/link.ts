...
import { buildEntityIndex, type EntityIndex } from '@versatly/clawvault-core/lib/entity-index.js';
import { autoLink, dryRunLink, findUnlinkedMentions } from '@versatly/clawvault-core/lib/auto-linker.js';
import { readBacklinksIndex, rebuildBacklinksIndex, scanVaultLinks } from '@versatly/clawvault-core/lib/backlinks.js';
import { resolveVaultPath } from '@versatly/clawvault-core/lib/config.js';
import { buildOrUpdateMemoryGraphIndex } from '@versatly/clawvault-core/lib/memory-graph.js';

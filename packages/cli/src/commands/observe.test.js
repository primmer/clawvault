...
describe('observeCommand', () => {
    it('uses parseSessionFile for one-shot compression input', async () => {
        ...
        expect(processMessagesMock).toHaveBeenCalledWith(['user: line one', 'assistant: line two'], expect.objectContaining({
            source: 'openclaw',
    ...
    it('routes --active execution to active session observer', async () => {
        ...
        expect(observeActiveSessionsMock).toHaveBeenCalledWith(expect.objectContaining({

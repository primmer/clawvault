...
vi.mock('@versatly/clawvault-core/observer/session-parser.js', () => ({
  parseSessionFile: parseSessionFileMock
}));

vi.mock('@versatly/clawvault-core/observer/observer.js', () => ({
  Observer: class {
...
vi.mock('@versatly/clawvault-core/observer/watcher.js', () => ({

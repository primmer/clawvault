...
import { archiveProject, createProject, getProjectActivity, getProjectTasks, listProjects, readProject, updateProject } from '@versatly/clawvault-core/lib/project-utils.js';
...
export function buildProjectBoardLanes(projects, groupBy) {
...
export function generateProjectBoardMarkdown(projects, options = {}) {
...
export function syncProjectBoard(vaultPath, options = {}) {
    const groupBy = normalizeBoardGroupBy(options.groupBy);
...
export function projectAdd(vaultPath, title, options = {}) {
...
export function projectUpdate(vaultPath, slug, options) {
...
export function projectArchive(vaultPath, slug, options = {}) {
    return archiveProject(vaultPath, slug, options.reason);
}
export function projectList(vaultPath, options = {}) {
    const projects = listProjects(vaultPath, {
        status: options.status,
        owner: options.owner,
        client: options.client,
...
export function formatProjectDetails(vaultPath, project, options = {}) {
    const lines = [];
...
export async function projectCommand(vaultPath, action, args) {

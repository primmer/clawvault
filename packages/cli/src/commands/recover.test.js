...
import { formatRecoveryInfo, recover, checkRecoveryStatus, formatCheckpointList, formatRecoveryCheckStatus, listCheckpoints } from './recover.js';
function makeTempVaultDir() {
...
describe('recover --list helpers', () => {
    it('lists checkpoints newest-first from checkpoint history directory', () => {
        ...
        try {
            ...
            fs.writeFileSync(path.join(checkpointsDir, '2024-01-01T00-00-00-000Z.json'), JSON.stringify({
                timestamp: '2024-01-01T00:00:00.000Z',
                workingOn: 'first',
                focus: 'setup',
                blocked: null
            }));
            fs.writeFileSync(path.join(checkpointsDir, '2024-01-02T00-00-00-000Z.json'), JSON.stringify({
...
//# sourceMappingURL=recover.test.js.map
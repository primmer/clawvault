...
const { createHandoffMock, clearDirtyFlagMock, parseSessionFileMock, processMessagesMock, flushMock } = vi.hoisted(() => ({
...
describe('sleep', () => {
    it('runs observer on transcript and returns routing summary', async () => {
        ...
        expect(processMessagesMock).toHaveBeenCalledWith(['user: ship feature', 'assistant: completed'], expect.objectContaining({
            source: 'openclaw',

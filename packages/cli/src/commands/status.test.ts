...
vi.mock('@versatly/clawvault-core/lib/search.js', async () => {
  const actual = await vi.importActual<typeof import('@versatly/clawvault-core/lib/search.js')>('@versatly/clawvault-core/lib/search.js');
  return {
    ...actual,
    hasQmd: hasQmdMock
  };
...
vi.mock('@versatly/clawvault-core/observer/active-session-observer.js', () => ({
  getObserverStaleness: getObserverStalenessMock
}));

vi.mock('@versatly/clawvault-core/lib/vault.js', () => ({
  ClawVault: class {
...
import { QmdUnavailableError } from '@versatly/clawvault-core/lib/search.js';

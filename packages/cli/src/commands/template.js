...
import { buildTemplateVariables, renderTemplate } from '@versatly/clawvault-core/lib/template-engine.js';
import { buildTemplateIndex, normalizeTemplateName, parseTemplateDefinition, renderDocumentFromTemplate, listTemplateDefinitions as listPrimitiveTemplateDefinitions, TEMPLATE_EXTENSION } from '@versatly/clawvault-core/lib/primitive-templates.js';
...
export function createFromTemplate(name, options = {}) {
...
export function addTemplate(file, options) {
